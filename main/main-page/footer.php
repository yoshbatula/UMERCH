        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    <li class="d-flex align-items-center mb-2">
                        ...
                        <div class="ms-2">
                            <p class="mb-0">Button St, Poblation District,</p>
                            <p class="mb-0">Dewor City, 8000 Dewor del Sur</p>
                        </div>
                    </li>
                    <li class="d-flex align-items-center mb-2">
                        ...
                        <div class="ms-2">
                            <p class="mb-0">drreng@dampel.com</p>
                            <p class="mb-0">drng@dampel.com</p>
                        </div>
                    </li>
                    <li class="d-flex align-items-center mb-2">
                        ...
                        <div class="ms-2">
                            <p class="mb-0">02234567890</p>
                            <p class="mb-0">01234567890</p>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="social-icons">
                    ...
                    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m17.687 3.063l-4.996 5.711l-4.32-5.711H2.112l7.477 9.776l-7.086 8.099h3.034l5.469-6.25l4.78 6.25h6.102l-7.794-10.304l6.625-7.571zm-1.064 16.06L5.654 4.782h1.803l10.846 14.34z"/></svg></a>
                </div>
            </div>
        </div>
    </div>
</footer>
<footer class="mt-3 text-center" style="color: #727272">
    <label class="mb-4">Copyright © 2025 Clothing Store | Powered by Clothing Store</label>
</footer>
</body>
</html>